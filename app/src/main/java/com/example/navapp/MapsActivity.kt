...
class MapsActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    override fun onMapReady(googleMap: GoogleMap) {
        ...
        val haifa = LatLng(32.794044, 34.989571)
        mMap.addMarker(MarkerOptions().position(haifa).title("Marker in Haifa"))
        mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(haifa, 15f)) // Set a suitable zoom level
